				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						...
						<!-- <a href="viewCart"><c:out value="${cart.size()}">Items</c:out></a> -->
							<li class="nav-item"><a href="cart.jsp" class="cart"><span class="ti-bag"></span>[<c:out value="${cart.size()}">Items</c:out>]</a></li>
							<li class="nav-item">
								<button class="search"><span class="lnr lnr-magnifier" id="search"></span></button>
							</li>
						</ul>
						<ul class="nav navbar">
						<li class="nav-item"><c:if test="${empty uid}">
                        <a href="login?c=Index">SignIn</a><br/>
                          </c:if></li>
                          <li class="nav-item"> <c:if test="${not empty uid}">
                          Welcome <a href="home"><c:out value="${uid}"></c:out></a>
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
							<img class="img-fluid" src="${pr.base64Image}" width="340" height="300" alt="">
							<div class="product-details">
								<h6><c:out value="${pr.name}"></c:out></h6>
								<div class="price">
									<h6><c:out value="${pr.price}"></c:out></h6>
									<h6 class="l-through">$210.00</h6>
								</div>
								<div class="prd-bottom">

									<a href="addCart?id=${pr.id}" class="social-info">
