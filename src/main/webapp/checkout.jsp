 ...
 <c:if test="${not empty uid}">
  <a href="OrderServlet" >Place Order</a>
                            ...
                            <ul class="list">
                                ...
                                <c:set var="total" value="${0}"/>
                                <c:forEach var="pr" items="${cart}" >
                                <li><a href="#"><c:out value="${pr.name}"></c:out> <span class="middle">x <c:out value="${pr.quantity}"></c:out></span> <span class="last"><c:out value="${pr.price*pr.quantity}"></c:out><br/></span></a></li>
                                <c:set var="total" value="${total+pr.price*pr.quantity }"></c:set>
                                </c:forEach>
                            </ul>
                            <ul class="list list_2">
                                <li><a href="#">Subtotal <span><c:out value="${total}"></c:out></span></a></li>
                                <li><a href="#">Shipping <span>Flat rate: 50.00</span></a></li>
                                <li><a href="#">Total <span><c:out value="${total+50}"></c:out></span></a></li>
                            </ul>
                            ...
                            <a class="primary-btn" href="OrderServlet">Place Order</a>
                        </div>
                    </div>
                </div>
            </div>
